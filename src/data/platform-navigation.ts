...
export const platformNavigationItems: readonly PlatformNavigationItem[] = [
  { id: "ai-video-center", index: "01", titleZh: "AI影音中心", titleEn: "AI Video Center", description: "AI 影片製作、自動剪輯與內容再製。", status: "Prototype Ready", comingSoon: false, category: "AI PRODUCTION" },
