...
export function MarketRadarPage({ report }: { report: MarketRadarReport }) {
  ...
  return <div className="market-radar-page"><div className="market-radar-page__texture" aria-hidden="true" />
    <section className="market-radar-hero" aria-labelledby="market-radar-title"><div className="market-radar-container market-radar-hero__grid"><div className="market-radar-hero__content"><div className="market-radar-hero__meta"><span>E.X MARKET RADAR</span><b>MOCK DATA · MVP</b></div><p className="market-radar-kicker">Kaohsiung Housing Brief</p><h1 id="market-radar-title">高雄房市快報</h1><p className="market-radar-hero__date"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="8.25" /><path d="M12 7.5v4.85l3.25 1.85" /></svg><span>{report.date}｜{report.updatedAt}</span></p><p className="market-radar-hero__summary">{report.summary}</p><p className="market-radar-hero__notice">本頁為 UI 與 Mock Data 展示，不代表即時市場資訊或投資建議。</p><svg className="market-radar-hero__skyline" viewBox="0 0 500 270" aria-hidden="true"><path d="M0 247h38v-42h26v42h30v-76h25v76h23V40h8v207h36v-58h34v58h30v-97h38v97h29v-55h34v55h34v-81h32v81h31v-45h41v45h55" /><path d="M0 254h500" /></svg></div><div className="market-radar-hero__download"><MarketRadarDownloadSection report={report} /></div></div></section>
