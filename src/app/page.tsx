...
export default function Home() {
  return <div className="mx-auto max-w-6xl px-5 sm:px-8">
    <section className="py-14 sm:py-20">
      <p className="eyebrow">Knowledge, made approachable</p>
      <h1 className="mt-4 max-w-3xl text-4xl font-bold leading-tight text-white sm:text-6xl">E.X Learning<br /><span className="text-cyan-300">& Knowledge Hub</span></h1>
      <p className="mt-5 max-w-xl text-base leading-7 text-slate-300">一個整理 AI、創作、健康與終身學習的公開入口；用清楚的方法，讓知識真正能被使用。</p>
