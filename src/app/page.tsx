...
export default function Home() {
  return <div className="home-page">
    ...
    <section aria-labelledby="learning-apps" className="home-learning-section"><div className="mb-6 flex flex-wrap items-end justify-between gap-4"><div><p className="eyebrow">E.X AI App Ecosystem</p><h2 id="learning-apps" className="mt-2 text-3xl font-semibold text-white">Learning Apps</h2><p className="mt-2 max-w-2xl text-sm leading-6 text-slate-300">五個可立即使用的互動入口，串起 AI 脈動、房產資料、知識、練習與未來的 AI 工具中心。</p></div><span className="rounded-full border border-cyan-300/20 bg-cyan-300/5 px-3 py-1.5 text-xs text-cyan-100">OPEN IN NEW TAB</span></div><div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">{learningApps.map((app) => <LearningAppCard app={app} key={app.id} />)}</div><div className="ecosystem-rail" aria-label="未來 AI 應用生態系"><span>AI PULSE / REALTY DATA / STK / ENG / JP</span><i /><span>SEEDANCE LAB</span><i /><span>VOICE STUDIO</span><i /><span>AI VIDEO STUDIO</span></div></section>
    <CreatorAcademyPromo />
